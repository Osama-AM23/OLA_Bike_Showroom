            ...
            <body>
                                ...
                                <div class="image-carousel">
                                    ...
                                    <div class="carousel-images">
                                        <c:forEach var="img" items="${fn:split(bike.imgPaths, ',')}" varStatus="loop">
                                            <img src="bikesDisplay?imgPaths=${img}" class="${loop.index == 0 ? 'active' : ''}" />
                                        </c:forEach>
                                    </div>
                ...
                <script>
                    ...
                    function prevImage(button) {
                        const carousel = button.closest('.image-carousel').querySelector('.carousel-images');
                        const images = carousel.querySelectorAll('img');
                        let index = Array.from(images).findIndex(image => image.classList.contains('active'));
                        index = (index - 1 + images.length) % images.length;
                        updateSlide(carousel, images, index);
                    }
                    ...
                    function updateSlide(carousel, images, index) {
                    ...
                    window.addEventListener('DOMContentLoaded', () => {
                        ...
                        allCarousels.forEach(carousel => {
                            const images = carousel.querySelectorAll('img');
                            images[0].classList.add('active'); // Set the first image as active initially
                        });
                    });
                </script>
